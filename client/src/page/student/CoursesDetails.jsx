    ...
    <>
      <div className=" flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        <div className=" max-w-xl z-10 text-gray-500">
          ...
          <p className="text-sm">
            Course by- <span className="text-blue-600 underline">Ajitesh</span>{" "}
          </p>
        ...
        <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[400px]">
          ...
          <div className="p-5">
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <p className="md:text-lg text-red-500  line-through ">
                {currency}
                {courseData.coursePrice}
              </p>
              <p className="md:text-lg text-green-600">
                {courseData.discount}% off
              </p>
            </div>
            <div className="flex items-center text-sm md:text-default gap-x-4 pt-2 md:pt-4 text-gray-500">
            ...
            <button className="md:mt-6 mt-4 w-full py-3 rounded-full bg-blue-600 text-white font-medium">
